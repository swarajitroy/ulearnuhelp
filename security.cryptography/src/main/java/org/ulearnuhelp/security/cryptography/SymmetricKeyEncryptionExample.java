...
/**
* 
* This class is an example class to demonstrate usage of java.crypto.Cipher, java.crypto.SecretKey to demonstrate an encryption and decryption using
...
* 
* However for knowledge purpose, one should look into history of symmetric key algorithms and take a look into algorithms like
...
public class SymmetricKeyEncryptionExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Security Provider Name for Symmetric Key Generator = " + keyGenerator.getProvider().getName());
			System.out.println("Security Provider version for Symmetric Key Generator = " + keyGenerator.getProvider().getVersion());
			System.out.println("Security Provider info for Symmetric Key Generator = " + keyGenerator.getProvider().getInfo());
